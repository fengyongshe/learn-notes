...
public class HdfsOverFtpServer {
	...
	public static void main(String[] args) throws Exception {
		...
		// "E:\\h\\hadoop-2.3.0-cdh5.1.2");
		System.setProperty("hadoop.home.dir", "E:\\h\\hadoop-2.3.0");
		loadConfig();
		if (port != 0) {
			startServer();
		}
	...
	private static void loadConfig() throws IOException {
		 ...
		 */
		/*
		 * String superuser = props.getProperty("superuser"); if (superuser ==
		 * null) { log.fatal("superuser is not set"); System.exit(1); }
